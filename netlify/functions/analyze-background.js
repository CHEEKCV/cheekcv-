...
exports.handler = async (event) => {
  ...
  try {
    ...
    const response = await httpsPost({
      ...
      messages: [{
        role: "user",
        content: `أنت محلل مهني سعودي خبير ومباشر. حلل هذه السيرة الذاتية وقدم تحليل كامل:
...
كن مباشراً وجريئاً. استخدم لهجة سعودية. اعطني تحليل عميق، توصيات عملية، ووظائف بأرقام رواتب واقعية للسوق السعودي.`
      }]
    });
